      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto space-y-16 text-center">
          ...
          <div className="space-y-6">
            <h1 className="text-5xl font-extrabold text-accentIndigo">Try Our Demo</h1>
            ...
            <div className="bg-surface text-textPrimary border-l-4 border-primaryDark px-6 py-8 rounded shadow-lg text-center text-xl font-semibold max-w-xl mx-auto">
              Demo Site Launch: <span className="text-2xl font-semibold text-accentIndigo">May 21</span>
            </div>
          </div>

          {/* Call to Action */}
          <div>
            <p className="textMuted mb-4">Want early access or a walkthrough?</p>
            <a
              href="/book-a-call"
